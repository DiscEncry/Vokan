...
export async function generateClozeQuestion(input: GenerateClozeQuestionInput): Promise<GenerateClozeQuestionOutput> {
  return generateClozeQuestionFlow(input);
}
