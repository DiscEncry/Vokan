...
const guideText = `
Vokan uses a Spaced Repetition System (SRS) called FSRS to help you remember vocabulary efficiently.
...
- **How does Vokan decide when to show a word?**
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto p-0">
          <DialogHeader className="px-6 pt-6">
            <DialogTitle>How Spaced Repetition Works in Vokan</DialogTitle>
          </DialogHeader>
          <div className="px-6 pb-2 pt-2">
            ...
            <section className="mb-4">
              <h2 className="font-semibold text-base mb-1">How does Vokan decide when to show a word?</h2>
