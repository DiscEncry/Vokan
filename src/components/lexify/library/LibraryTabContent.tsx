  ...
  return (
    <div className="space-y-6 p-2 sm:p-4 md:p-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
        ...
        {isSyncing && (
          <span className="flex items-center gap-2 text-lg text-primary font-semibold animate-pulse">
            <svg className="h-5 w-5 animate-spin text-primary" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"></path></svg>
            Syncing...
          </span>
        )}
      </div>
